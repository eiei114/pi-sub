...
- [#85](https://github.com/eiei114/pi-sub/pull/85) [`b97ecdf`](https://github.com/eiei114/pi-sub/commit/b97ecdf8267a80815556f3224180cfdc3f4c7458) Thanks [@eiei114](https://github.com/eiei114)! - Minor version bump for the fixed release group (`sub-core` / `sub-bar` / `sub-shared`).

  No functional changes: this changeset only rolls the fixed group forward to the next
  minor version so the release can ship on its own.
...
- Updated dependencies [[`ff47bf5`](https://github.com/eiei114/pi-sub/commit/ff47bf59be47d1493d95093639feedf670bd625e)]:
  - @eiei114/pi-sub-shared@2.5.0

## 2.4.0

### Minor Changes

- [#77](https://github.com/eiei114/pi-sub/pull/77) [`0aceb0b`](https://github.com/eiei114/pi-sub/commit/0aceb0be28f2abb51a702007d1e0c302f271ad8a) Thanks [@eiei114](https://github.com/eiei114)! - Distinguish the OpenRouter per-key spending cap from account wallet credit.
...
- [#78](https://github.com/eiei114/pi-sub/pull/78) [`9ecc420`](https://github.com/eiei114/pi-sub/commit/9ecc4207580d053ac1f5c8581b8923b6823517d4) Thanks [@eiei114](https://github.com/eiei114)! - Add an xAI (Grok) subscription usage provider.
...
- Updated dependencies [[`0aceb0b`](https://github.com/eiei114/pi-sub/commit/0aceb0be28f2abb51a702007d1e0c302f271ad8a), [`9ecc420`](https://github.com/eiei114/pi-sub/commit/9ecc4207580d053ac1f5c8581b8923b6823517d4)]:
  - @eiei114/pi-sub-shared@2.4.0
...
- [#76](https://github.com/eiei114/pi-sub/pull/76) [`96281bd`](https://github.com/eiei114/pi-sub/commit/96281bdee0dd7432b58dcc0598e74b3ab0ca830b) Thanks [@eiei114](https://github.com/eiei114)! - Restrict root-level Command Code API-key discovery to its own native auth file. Shared Pi and OMP auth files now require a provider-scoped Command Code entry, so unrelated root credentials cannot be selected. Environment precedence and native-file compatibility are unchanged.
- Updated dependencies [[`29e0f83`](https://github.com/eiei114/pi-sub/commit/29e0f83baafab49fe6eb489b680f2a6e07b87de2)]:
...
- [#69](https://github.com/eiei114/pi-sub/pull/69) [`c41b535`](https://github.com/eiei114/pi-sub/commit/c41b535d66fa90eb60a19ec4db5dd6f1ac69b9c0) Thanks [@tryingET](https://github.com/tryingET)! - Add an optional versioned, selective read-only usage event for exact base providers. Consumers can inspect a supported provider without changing selection, querying all providers, or reusing shared provider-cache data. Bound reads by cancellation and timeout; preserve disabled settings and reject account aliases.

### Patch Changes

- Updated dependencies [[`c41b535`](https://github.com/eiei114/pi-sub/commit/c41b535d66fa90eb60a19ec4db5dd6f1ac69b9c0)]:
  - @eiei114/pi-sub-shared@2.3.0
...
- Updated dependencies [[`a304bb7`](https://github.com/eiei114/pi-sub/commit/a304bb7ec274a5d65031431f918a03427b1bb747)]:
  - @eiei114/pi-sub-shared@2.2.3
...
- [#41](https://github.com/eiei114/pi-sub/pull/41) [`6fc531b`](https://github.com/eiei114/pi-sub/commit/6fc531b696e92dc0beb3b274b7328868ecf8a54f) Thanks [@eiei114](https://github.com/eiei114)! - Fix sub-core Settings hint overflow crash on narrow terminals by truncating after theme.hint.

- Updated dependencies []:
  - @eiei114/pi-sub-shared@2.1.2
